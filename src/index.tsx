    ...
    *
    ...
    export enum BarcodeFormat {
      ...
      export function scanBarcodes(
        ...
        'worklet'
        // @ts-ignore
        if (barcodePlugin == null) throw new Error('Failed to load Frame Processor Plugin "vision_camera_barcode_scanner2"!');
        
        return barcodePlugin?.call(frame, {types:types, options:options as any}) as unknown as Barcode[];
    }