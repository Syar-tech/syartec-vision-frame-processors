...
import static com.syartecvisionframeprocessors.BarcodeConverter.convertToArray;
import static com.syartecvisionframeprocessors.BarcodeConverter.convertToMap;
...
public class VisionCameraCodeScannerPlugin extends FrameProcessorPlugin {
  ...
  public Object callback(@NotNull Frame frame, @Nullable Map<String, Object> params) {
    ...
    if (mediaImage != null) {
      ...
      if (params.get("options") instanceof Map) {
        ...
        boolean checkInverted = (boolean) scannerOptions.get("checkInverted");
  ...
  private void createBarcodeInstance(@Nullable Map<String, Object> params) {
    Log.i("SCANNER", params.get("types").getClass().toString());
    if (params.get("types") instanceof List) {
      List rawFormats = (List) params.get("types");
      ...
      for (int i = 0; i < formatsSize; i++) {
        int format = ((Double) rawFormats.get(i)).intValue();
  ...
  private HashMap<String,Object> convertContent(@NonNull Barcode barcode) {
  ...
  private HashMap<String,Object> convertBarcode(@NonNull Barcode barcode) {
    HashMap<String,Object> map = new HashMap<>();
